...
/*
Dadas as informações de população e a taxa de crescimento de duas cidades quaisquer (A e B), calcule quantos anos levará para que a cidade menor (sempre é a cidade A) ultrapasse a cidade B em população.
A cidade A tem taxa sempre maior do que a taxa de crescimento da cidade B.
Construa um programa que apresente o tempo em anos para cada caso de teste.
Para casos em que o tempo seja maior que 100 anos, basta que você informe, nesta situação, a mensagem "Mais de 1 século.".
Entrada
